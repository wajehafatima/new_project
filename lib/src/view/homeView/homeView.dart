          ...
          child: Container(color: Colors.white,
            child: ListView(
              ...
              children: [
                ...
                CustomListTile(
                    icon: Icons.edit_calendar_outlined, title: 'Daily tasks'),
                ...
                CustomListTile(icon: Icons.logout, title: 'Logout', onTap: () {
                  auth.signOut().then((value) {
                    Navigator.pushReplacement(context, MaterialPageRoute(
                        builder: (context) => Loginview())).onError((error,
                        stackTrace) {
                ...
                Padding(
                  ...
                  child: Column(
                      children: [SizedBox(height: 20.h,),
                          ...
                          children: [
                            Timebuttons(text: 'Today', onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => Insertdataview()),
                              );
                            }),
                        ...
                        Wrap(
                          children: [
                            Taskbox(backgroundColor: Color(0xff2A8899),
                                imagePath: Appimages.school,
                                title: 'School',
                                countText: '7',
                                titleColor: Colors.white),
                            Taskbox(backgroundColor: Color(0xff5EB0D2),
                                imagePath: Appimages.work,
                                title: 'Work',
                                countText: '6',
                                titleColor: Colors.white),
                            Taskbox(backgroundColor: Color(0xffBE8972),
                                imagePath: Appimages.shop,
                                title: 'Shop',
                                countText: '3',
                                titleColor: Colors.white),
                            Taskbox(backgroundColor: Color(0xff646FD4),
                                imagePath: Appimages.read,
                                title: 'Read',
                                countText: '4',
                                titleColor: Colors.white),
                            Taskbox(backgroundColor: Color(0xff83BC74),
                                imagePath: Appimages.health,
                                title: 'Workout',
                                countText: '1',
                                titleColor: Colors.white)
                            ,
                            Taskbox(backgroundColor: Color(0xffffe8e8),
