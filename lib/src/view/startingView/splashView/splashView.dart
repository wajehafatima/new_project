      ...
      body: Center(
        child: Padding(
          ...
          Image.asset(Appimages.SplashLogoImage),
            ...
            Text('Manage your Tasks',style: GoogleFonts.jost(fontWeight: FontWeight.w500, fontSize:24.sp),),
          Container(height: 85.h,
          width: 285.w,
            child: Text('organize, plan, and collaborate on tasks with Mtodo.Your busy life deserves this.you can manage checklist and your goal. ',style: GoogleFonts.roboto(color: Color(0xff8D93AB),fontSize: 12.sp,fontWeight: FontWeight.w400),),
          ),
            SizedBox(height: 40.h,),
